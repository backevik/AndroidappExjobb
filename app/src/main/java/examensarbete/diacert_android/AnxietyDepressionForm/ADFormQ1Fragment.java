 ...
 */
public class ADFormQ1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ad_form_view_q1, container, false);
        ...
        if(bundle == null){
            ...
            if(bundle.getInt("q1") == 4){qa11.toggle();}
            else if(bundle.getInt("q1") == 3){qa12.toggle();}
            else if(bundle.getInt("q1") == 2){qa13.toggle();}
            else if(bundle.getInt("q1") == 1){qa14.toggle();}
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!qa11.isChecked() && !qa12.isChecked() && !qa13.isChecked() && !qa14.isChecked()){
                    ...
                    if(qa11.isChecked()){bundle.putInt("q1",4); bundle.putString("qt1","Mestadels");}
                    if(qa12.isChecked()){bundle.putInt("q1",3); bundle.putString("qt1","Ofta");}
                    if(qa13.isChecked()){bundle.putInt("q1",2); bundle.putString("qt1","Av och till");}
                    if(qa14.isChecked()){bundle.putInt("q1",1); bundle.putString("qt1","Inte alls");}
