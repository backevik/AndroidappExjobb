 ...
 */
public class ADFormQ4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ad_form_view_q4, container, false);
        ...
        final CheckBox qa11 = (CheckBox) v.findViewById(R.id.qa41);
        final CheckBox qa12 = (CheckBox) v.findViewById(R.id.qa42);
        final CheckBox qa13 = (CheckBox) v.findViewById(R.id.qa43);
        final CheckBox qa14 = (CheckBox) v.findViewById(R.id.qa44);

        bundle = this.getArguments();
        if(bundle == null){
            bundle = new Bundle();
        }else{
            if(bundle.getInt("q4") == 1){qa11.toggle();}
            else if(bundle.getInt("q4") == 2){qa12.toggle();}
            else if(bundle.getInt("q4") == 3){qa13.toggle();}
            else if(bundle.getInt("q4") == 4){qa14.toggle();}
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!qa11.isChecked() && !qa12.isChecked() && !qa13.isChecked() && !qa14.isChecked()){
                    ...
                    if(qa11.isChecked()){bundle.putInt("q4",1); bundle.putString("qt4","Definitivt lika mycket");}
                    if(qa12.isChecked()){bundle.putInt("q4",2); bundle.putString("qt4","Inte lika mycket");}
                    if(qa13.isChecked()){bundle.putInt("q4",3); bundle.putString("qt4","Endast delvis");}
                    if(qa14.isChecked()){bundle.putInt("q4",4); bundle.putString("qt4","Väldigt ofta");}
