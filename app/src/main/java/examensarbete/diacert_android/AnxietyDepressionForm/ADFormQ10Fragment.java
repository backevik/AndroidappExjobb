 ...
 */
public class ADFormQ10Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ad_form_view_q10, container, false);
        ...
        final CheckBox qa11 = (CheckBox) v.findViewById(R.id.qa101);
        final CheckBox qa12 = (CheckBox) v.findViewById(R.id.qa102);
        final CheckBox qa13 = (CheckBox) v.findViewById(R.id.qa103);
        final CheckBox qa14 = (CheckBox) v.findViewById(R.id.qa104);

        if(bundle != null){
            if(bundle.getInt("q10") == 1){qa11.toggle();}
            else if(bundle.getInt("q10") == 2){qa12.toggle();}
            else if(bundle.getInt("q10") == 3){qa13.toggle();}
            else if(bundle.getInt("q10") == 4){qa14.toggle();}
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!qa11.isChecked() && !qa12.isChecked() && !qa13.isChecked() && !qa14.isChecked()){
                    ...
                    if(qa11.isChecked()){bundle.putInt("q10",1); bundle.putString("qt10","Lika mycket som tidigare");}
                    if(qa12.isChecked()){bundle.putInt("q10",2); bundle.putString("qt10","Mindre än tidigare");}
                    if(qa13.isChecked()){bundle.putInt("q10",3); bundle.putString("qt10","Mycket mindre än tidigare");}
                    if(qa14.isChecked()){bundle.putInt("q10",4); bundle.putString("qt10","Knappast alls");}
