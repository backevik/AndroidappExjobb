 ...
 */
public class ADFormQ7Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ad_form_view_q7, container, false);
        ...
        final CheckBox qa11 = (CheckBox) v.findViewById(R.id.qa71);
        final CheckBox qa12 = (CheckBox) v.findViewById(R.id.qa72);
        final CheckBox qa13 = (CheckBox) v.findViewById(R.id.qa73);
        final CheckBox qa14 = (CheckBox) v.findViewById(R.id.qa74);

        if(bundle != null){
            if(bundle.getInt("q7") == 4){qa11.toggle();}
            else if(bundle.getInt("q7") == 3){qa12.toggle();}
            else if(bundle.getInt("q7") == 2){qa13.toggle();}
            else if(bundle.getInt("q7") == 1){qa14.toggle();}
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!qa11.isChecked() && !qa12.isChecked() && !qa13.isChecked() && !qa14.isChecked()){
                    ...
                    if(qa11.isChecked()){bundle.putInt("q7",4); bundle.putString("qt7","Väldigt ofta");}
                    if(qa12.isChecked()){bundle.putInt("q7",3); bundle.putString("qt7","Ganska ofta");}
                    if(qa13.isChecked()){bundle.putInt("q7",2); bundle.putString("qt7","Sällan");}
                    if(qa14.isChecked()){bundle.putInt("q7",1); bundle.putString("qt7","Inte alls");}
