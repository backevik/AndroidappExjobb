 ...
 */
public class ADFormQ14Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ad_form_view_q14, container, false);
        ...
        final CheckBox qa11 = (CheckBox) v.findViewById(R.id.qa141);
        final CheckBox qa12 = (CheckBox) v.findViewById(R.id.qa142);
        final CheckBox qa13 = (CheckBox) v.findViewById(R.id.qa143);
        final CheckBox qa14 = (CheckBox) v.findViewById(R.id.qa144);

        if(bundle != null){
            if(bundle.getInt("q14") == 1){qa11.toggle();}
            else if(bundle.getInt("q14") == 2){qa12.toggle();}
            else if(bundle.getInt("q14") == 3){qa13.toggle();}
            else if(bundle.getInt("q14") == 4){qa14.toggle();}
        }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!qa11.isChecked() && !qa12.isChecked() && !qa13.isChecked() && !qa14.isChecked()){
                    ...
                    if(qa11.isChecked()){bundle.putInt("q14",1); bundle.putString("qt14","Ofta");}
                    if(qa12.isChecked()){bundle.putInt("q14",2); bundle.putString("qt14","Ibland");}
                    if(qa13.isChecked()){bundle.putInt("q14",3); bundle.putString("qt14","Sällan");}
                    if(qa14.isChecked()){bundle.putInt("q14",4); bundle.putString("qt14","Mycket sällan");}

                    ADFormResultFragment adFormResultFragment = new ADFormResultFragment();
                    adFormResultFragment.setArguments(bundle);
                    FragmentManager fragmentManager = getFragmentManager();
                    FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                    fragmentTransaction.setCustomAnimations(R.animator.fade_in_forms, R.animator.fade_out_forms);
                    fragmentTransaction.add(R.id.form_rel_layout, adFormResultFragment, "Result fragment Active");
                    fragmentTransaction.addToBackStack(null);
                    fragmentTransaction.commit();
                }
            }
